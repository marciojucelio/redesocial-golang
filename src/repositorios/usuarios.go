...
// Usuarios represente um repositorio de usuarios
...
// BuscarPorID busca somente um usuario no banco
...
// Atualizar altera informações de um usuario no banco de dados
...
// BuscarPorEmail busca um usuario por email no banco e retorna seu ID e Senha com Hash
